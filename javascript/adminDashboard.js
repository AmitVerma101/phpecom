...
let newSellerHTML = newSellerBtn.innerHTML;
...
function deleteSellerBtn(username){
    ...
    let data ={username:username,type:'delete'};
...
function deleteElementFromAdmin(id){
    let data ={productid:id,type:'deleteProduct'};
